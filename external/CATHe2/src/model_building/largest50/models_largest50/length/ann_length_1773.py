...
X_train_df = list(pd.read_csv('../../../all/data/final/Train.csv')["Sequence"])
# print(X_train_df)

X_train_full = []

for i in X_train_df:
    X_train_full.append(len(i))

X_test_df = list(pd.read_csv('../../../all/data/final/Test.csv')["Sequence"])
# print(X_train_df)

X_test_full = []

for i in X_test_df:
    X_test_full.append(len(i))

X_val_df = list(pd.read_csv('../../../all/data/final/Val.csv')["Sequence"])
# print(X_train_df)

X_val_full = []

for i in X_val_df:
    X_val_full.append(len(i))
...
print(len(y_train))
# val
ds_val = pd.read_csv('../../../all/data/final/Val.csv')
...
# Accuracy:  0.11000719424460433 0.006929242847943256
# F1-Score:  0.03138780873885641 0.0019198919667507244
# MCC:  0.09748299716511608 0.007980629550367373
# Bal Acc:  0.05295317634729621 0.0031436161550955355
# '''